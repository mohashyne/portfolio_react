const INFO = {
  ...
  projects: [
...

    {
	  ...
	  sourceLink: 'https://github.com/mohashyne/24hour_doctor-front_end.git',
...

    {
      title: 'Recipe app',
      description:
				'The Recipe app streamlines recipe management, allowing you to save ingredients, track inventory, create recipes, and generate shopping lists. Easily share your recipes with others by making them public.',
      logo: 'https://cdn.jsdelivr.net/npm/programming-languages-logos/src/javascript/javascript.png',
      ...
      sourceLink: 'https://github.com/mohashyne/Recipe_App',
      projectCover: './img/projects/Snapshoot_Portfolio_5.png',
      fullDescription: `
